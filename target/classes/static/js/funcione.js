...
$(document).on("click", ".simulaUm", function () {
  ...
  if(parseFloat(jQuery(".monto").val() * 1)==0){
    document.getElementById("mont").style.borderColor = "#ef0000";
    cont++;
  }
  else{
    document.getElementById("mont").style.borderColor = "#bdc3c7";
  }
  if(selected2=="Moneda"){
  ...
  if(selected=="Plazo(en días)"){
    document.getElementById("Plazo").style.borderColor = "#ef0000";
    cont++;
  }
  else{

    document.getElementById("Plazo").style.borderColor = "#bdc3c7";
  }
 if(cont==0){
 document.getElementById("subm").click();
  ...
  app
      ...
      querySnapshot.docs.map((doc) => {
        if (doc.data().item === selected) {
          ...
          if (tipmd === "Dolares") {
            monto = monto * 6.96;
            if(monto<70000){
              console.log(doc.data().valor1);
              tasa = doc.data().valor1;
              let Interesganado=0;
              let total =0;
              let tasaPush = tasa;
              
              if(doc.data().item=="mas de 1080"){
                Interesganado = (monto * tasa*1081)/36000;
              total = monto + Interesganado;
              }
              else{
                Interesganado = (monto * tasa*doc.data().item)/36000;
                total = monto + Interesganado;
              }
    ...
    if(selected2=="Moneda"){
      if(selected=="Plazo(en días)"){
        alert("Banco Sol Informa: Seleccione los Valores para el Tipo de Moneda y el Plazo en Dias.");
      }
      else{
        alert("Banco Sol Informa: Seleccione el Tipo de Moneda.");
      }
    }else{
      if(selected=="Plazo(en días)"){
        alert("Banco Sol Informa: Seleccione el Plazo en Dias.");
      }
    }
    console.log("hola");
